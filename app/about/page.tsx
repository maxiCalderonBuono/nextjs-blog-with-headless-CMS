...
const about = () => {
  return (
    <section className="w-full max-w-5xl px-10 py-10 mx-auto md:h-[calc(100vh-166px)]">
      ...
      <article className="flex flex-col gap-8 text-xl items-left">
        <p className="tracking-wide text-pretty text-balance">
          ...
          reflexionar sobre el mundo que nos rodea. Es en este punto donde entra
          en juego MINDENKIRE, un blog que ofrece una perspectiva única e
          introspectiva.
        </p>

        <p className="tracking-wide text-pretty text-balance">
          En un mundo cada vez más complejo y diverso, resulta insuficiente
          aferrarse a las estructuras unipolares heredadas de épocas bipolares.
          Nos enfrentamos a un futuro en el que los nacionalismos de inclusión o
          exclusión cobrarán protagonismo, dependiendo del modelo de país que
          adoptemos.
        </p>
